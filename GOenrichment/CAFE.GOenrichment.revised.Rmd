...
table_MF$FDR<-p.adjust(as.numeric(table_MF$parentChild),method="fdr")
# Biological Process
####################
...
table_BP$FDR<-p.adjust(as.numeric(table_BP$parentChild),method="holm")
...
table_CC$FDR<-p.adjust(as.numeric(table_CC$parentChild),method="fdr")
```
