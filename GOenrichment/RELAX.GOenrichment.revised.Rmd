...
#outfile<-"/Users/lukas/sciebo/inquilineGenomics18/GOenrichment/results/GOenrichment.RELAX2.parasiteOrigins.relaxedSelection.revision.tsv"
outfile<-"/Users/lukas/sciebo/inquilineGenomics18/GOenrichment/results/GOenrichment.RELAX2.parasiteOrigins.intensifiedSelection.revision.tsv"
...
cat("# GO enrichment of genes under intensified selection (p<0.05, k<1) at any social parasite branch (at FDR<0.1), compared to all other branches. \n",file=outfile)
...
# Origins of social parasitism
res<-rbind(MF,BP) %>% rbind(.,CC)
outfile<-"/Users/lukas/sciebo/inquilineGenomics18/GOenrichment/results/GOenrichment.RELAX2.parasiteOrigins.relaxedSelection.revision.FDR.tsv"
#outfile<-"/Users/lukas/sciebo/inquilineGenomics18/GOenrichment/results/GOenrichment.RELAX2.parasiteOrigins.intensifiedSelection.revision.FDR.tsv"
write.table(res,outfile,quote=F,sep="\t",row.names = F)
#cat("# GO enrichment of genes under relaxed selection (p<0.1, k<1) at any social parasite branch (at FDR<0.1), compared to Ahey, Aech, A1 and A2. \n",file=outfile)
