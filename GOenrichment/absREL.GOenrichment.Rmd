...
SCOOfInterest<-unlist(subset(all,p.adjust(P1pv,method = "fdr")<0.1 | p.adjust(AINSpv,method = "fdr")<0.1 ,OGid))
...
subset(all,OGid %in% genesInTerm(GOdata_MF, "GO:0016886")[[1]],kegg)
subset(all,OGid %in% genesInTerm(GOdata_BP, "GO:0042440")[[1]],kegg)
...
#cat("# GO enrichment of genes under positive selection at any social parasite branch (at FDR<0.1). \n",file=outfile)
