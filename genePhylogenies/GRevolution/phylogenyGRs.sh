#
base=/usr/local/home/lschrader/data/inqGen18/geneFamilies/specificFamilies/grs/tree
...
do
  awk '{print $0,FILENAME}' $i/*.GRs.GeMoMa.details.tsv
done | sed "s|/corefac/cse/lukas/inqGen18/geneFamilies/specificFamilies/grs/||g"|cut -f 1 -d "/" > tmp.details.tsv

# create clean summary file with names GRs
