...
############################################
t1<-read.tree("/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELG.complete.fast.tre")
t1<-midpoint.root(t1)
tree <- as(t1, 'TreeMan')
```

## Load tsv with information for each gene
Focus on complete (M*) and domain-containing genes ("ELO")
```{r}
############################################
# Load subfam assignments
############################################
subfam<-read.table("/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELG.details.tsv",sep="\t")
subfam<-subset(subfam,V3=="M*" & V2=="ELO")
...
dev.print(pdf,"/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELG.heatmap.pdf",width=4,height=7)
```
...
# 1st tier: species
p1 <- gheatmap(circ, data.frame(subfamTrait), offset=0.6, width=.02,
               colnames_angle=90, colnames_offset_y = 0.5,color = NA,colnames = F)
# 2nd tier: Clades changing in parasites
p2 <- gheatmap(p1, data.frame(smallerCladesTrait), offset=.52, width=.02,
...
dev.print(pdf,"/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELO.legend.pdf",width=10,height=10)
```
...
dev.print(pdf,"/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELG.complete.tree.pdf",width=7.5,height=7.5)
...
# save some things
save(cladesTree,file="/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELG.labeled.tree.Robject")
write.table(tipDF4,"/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELG.tipsDF4.tsv",quote=F,sep="\t",row.names = F)
write.table(tree_dt,"/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELG.tree_dt.tsv",quote=F,sep="\t",row.names = F)
write.table(cladeTable,"/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/specificFamilies/ELONGASEevolution/ELG.cladeTable.tsv",sep="\t",quote = F,row.names=F)
```
