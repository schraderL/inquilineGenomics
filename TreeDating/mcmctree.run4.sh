############################################################################################################
# TAG: 4th MCMCtree RUN - chain 10 times longer (replicate of 3rd run)
############################################################################################################
...
mkdir $base/mcmctree.sf50000.sr17.5cal.sigma2.5.5.run4/
cd $base/mcmctree.sf50000.sr17.5cal.sigma2.5.5.run4/
...
#############################
#TAG 1.2 Second run of MCMCtree
#############################
cp out.BV in.BV
cat mcmctree1.ctl | \
...
mv mcmc.txt mcmc.run4.txt
mv FigTree.tre FigTree.run4.tre
############################################################################################################
