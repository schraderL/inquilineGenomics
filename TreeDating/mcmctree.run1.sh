...
mkdir $base/mcmctree.sf500.sr17.5cal.sigma2.5.5.run1/
cd $base/mcmctree.sf500.sr17.5cal.sigma2.5.5.run1/
...
mv mcmc.txt mcmc.run1.txt
mv FigTree.tre FigTree.run1.tre
############################################################################################################
