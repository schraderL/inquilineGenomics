...
mkdir $base/p.mcmctree.sf500.sr17.5cal.sigma2.5.5.run4/
cd $base/p.mcmctree.sf500.sr17.5cal.sigma2.5.5.run4/
...
mv mcmc.txt p.mcmc.run4.txt
mv FigTree.tre p.FigTree.run4.tre
############################################################################################################
