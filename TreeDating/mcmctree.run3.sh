############################################################################################################
# TAG: 3rd MCMCtree RUN - chain 10 times longer
############################################################################################################
...
mkdir $base/mcmctree.sf50000.sr17.5cal.sigma2.5.5.run3/
cd $base/mcmctree.sf50000.sr17.5cal.sigma2.5.5.run3/
...
mv mcmc.txt mcmc.run3.txt
mv FigTree.tre FigTree.run3.tre
############################################################################################################
