############################################################################################################
# 1st priorMCMCtree RUN sampling from prior only
############################################################################################################
...
mkdir $base/p.mcmctree.sf500.sr17.5cal.sigma2.5.5.run1/
cd $base/p.mcmctree.sf500.sr17.5cal.sigma2.5.5.run1/
...
mv mcmc.txt p.mcmc.run1.txt
mv FigTree.tre p.FigTree.run1.tre
############################################################################################################
