...
c1<-read.csv("/Users/lukas/sciebo/inquilineGenomics18/geneFamilies/CAFE/results/Acro.Atta/allProperRuns.tsv",sep="\t")
c1<-c1[order(c1$likelihood,decreasing=F),]
points(c1[1,4:9],c1[1,15:20],cex=1,col="red",pch=19)
