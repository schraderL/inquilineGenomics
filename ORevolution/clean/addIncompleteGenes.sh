...
gt gff3 -sort -tidy  -checkids yes -retainids yes -fixregionboundaries -addintrons 2add_clean.gff > 2add.tmp.gff
gt merge -tidy -retainids 2add.tmp.gff   $species.final.OR.gff3 > $species.fullORannotation.gff3
rm 2add*
