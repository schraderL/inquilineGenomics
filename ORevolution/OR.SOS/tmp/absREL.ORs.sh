...
################################################################################
# TAG Prepare alignments and trees for Parg.Ains
################################################################################
target=Parg.Ains
...
# get subsetted fastas for each clade
ls $datafolder/*.tsv|parallel --nice 10 "cut -f 1 {}|sed 1d |egrep [0-9]$ > {.}.lst"
...
################################################################################
# TAG Prepare alignments and trees for Parg.Acha
################################################################################
target=Parg.Acha
datafolder=$base/data/$target
mkdir $base/cdsAln/$target
...
################################################################################
# TAG Prepare alignments and trees for Parg
################################################################################
target=Parg
datafolder=$base/data/$target
mkdir $base/cdsAln/$target
...
################################################################################
# TAG Prepare alignments and trees for 0
################################################################################
target=0
datafolder=$base/data/$target
mkdir $base/cdsAln/$target
