...
java -jar $GeMoMaJar CLI Extractor a=${annotation} g=${reference} outdir=${out} f=false
...
java -jar $GeMoMaJar CLI GeMoMa t=${out}/tblastn.txt c=${out}/cds-parts.fasta a=${out}/assignment.tabular tg=${target}  outdir=${out} p=60 m=180000
