...
do
	...
	perl $software/EVidenceModeler-1.1.1/EvmUtils/misc/exonerate_gff_to_alignment_gff3.pl exonerate/raw/$gene.exonerate > exonerate/PROTEIN/$gene.PROTEIN.gff
	echo "$gene done. :)"
done

cat exonerate/protFa/* > exonerate/$species.exonerate.pep

$software/genometools-1.5.9/bin/gt merge -tidy -retainids $base/$species/exonerate/gff/*.gff  > $base/$species/exonerate/$species.exonerate.gff
cat $base/$species/exonerate/PROTEIN/*.PROTEIN.gff  > $base/$species/exonerate/$species.exonerate.PROTEIN.gff
perl $software/EVidenceModeler-1.1.1/EvmUtils/gff3_gene_prediction_file_validator.pl $base/$species/exonerate/$species.exonerate.gff
perl $software/EVidenceModeler-1.1.1/EvmUtils/gff3_gene_prediction_file_validator.pl $base/$species/exonerate/$species.exonerate.PROTEIN.gff
